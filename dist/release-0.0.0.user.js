...
// @description ask ingts what it does
...
var rollupUserScript = (function (React, require$$0) {
  ...
  */
  ...
  var useInsertionEffect = React__namespace["useInsertion" + "Effect"]
    ...
    : false;
  var useInsertionEffectAlwaysWithSyncFallback = !isBrowser$1
    ? syncFallback
  ...
  var Emotion = /* #__PURE__ */ withEmotionCache(function (props, cache, ref) {
    ...
    var serialized = serializeStyles(
      registeredStyles,
      undefined,
      React__namespace.useContext(ThemeContext),
    );
  ...
  const ModalContextProvider = ({ children }) => {
    ...
    return jsxs(ModalContext.Provider, {
      value: {
        open,
        close,
      },
  ...
  const App = () => {
    ...
    function handleClick() {
      open(jsx("h1", { children: "Hello" }));
    }
    return jsx("div", {
      children: jsx("input", {
        type: "button",
        value: "Multiplatform Editing",
        onClick: handleClick,
      }),
    });
  };
  ...
  var index = (function () {
    ...
    const groupInfoNode = document.querySelector("#sidebar_group_info");
    sidebarNode.insertBefore(rootNode, groupInfoNode);
    createRoot(rootNode).render(
      jsx(React.StrictMode, {
        children: jsx(Providers, { children: jsx(App, {}) }),
      }),
    );
  })();
